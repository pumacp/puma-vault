...
authors: ["Wickman, Gino"]
first-author: "Wickman"
year: 2012
status: reviewed
topic: business-operating-system
relevance: 4
citekey: "@Wickman2012Traction"
venue: "BenBella Books"
arxiv: ""
doi: ""
...
> **Citation**: Wickman, G. (2012). *Traction: Get a grip on your business*. BenBella Books.
> **URL**: https://www.eosworldwide.com/traction-book
...
| **Context** | Wickman distilled 20+ years of consulting experience into EOS (Entrepreneurial Operating System) — a practical, whole-company operating system for small-to-midsize businesses (10–250 employees) |
| **Correctness** | Practitioner framework with thousands of validated implementations. EOS Worldwide reports 200,000+ companies using the system globally |
...
| **Clarity** | Excellent. Highly structured, tool-driven, implementation-focused. Every concept comes with a practical tool. |
...
| Component | Question it answers | Primary tool |
|-----------|--------------------|-----------| 
| **Vision** | Where are we going and how will we get there? | V/TO (Vision/Traction Organizer) |
| **People** | Do we have the right people in the right seats? | Accountability Chart + People Analyzer |
| **Data** | Do we have a pulse on the business? | Scorecard |
| **Issues** | How do we identify, discuss, and solve problems permanently? | Issues List + IDS process |
| **Process** | Have we documented and followed our core processes? | Process Documenter |
| **Traction** | How do we execute consistently and with discipline? | Rocks + L10 Meeting |
...
| EOS Component | SmartPMO / PUMA Application |
|--------------|----------------------------|
| Vision / V/TO | SmartPMO Vision document; 10-year target = autonomous PM for all ICT projects |
| People | Right agents in right roles (BMAD Agent Roster — Analyst, PM, QA, etc.) |
| Data / Scorecard | PUMA metrics dashboard: F1-macro, MAE, SA, incident rate, carbon |
| Issues / IDS | Issue triage as automated IDS: identify type → classify priority → assign |
| Process | PUMA skill files and SOPs as EOS Core Processes |
| Traction / Rocks | PUMA sprint Rocks: each experiment = a 90-day Rock with measurable outcome |
...
- [[50 - Areas/56 Smart-PMO/Smart-PMO-Vision]] — SmartPMO as an EOS-structured automated PM organisation
- [[20 - Literature/20.2 Books/LN-Carpenter-2025-WorkTheSystem]] — SOP documentation as EOS Process component
- [[20 - Literature/20.2 Books/LN-Gerber-2009-EMythRevisited]] — EOS operationalises the E-Myth's Mature stage
- [[20 - Literature/20.2 Books/LN-Harnish-2022-ScalingUp]] — Scaling Up extends EOS thinking to high-growth companies
- [[30 - Permanent/31 Concepts/PN-Evaluation-Metrics-Comprehensive]] — metrics as EOS Scorecard implementation
- [[30 - Permanent/33 Frameworks/PN-SDD-Framework]] — SDD as EOS Process documentation methodology
- [[40 - Projects/PUMA/41.9 BMAD-Agents/BMAD-Agent-Roster]] — BMAD agents as EOS Accountability Chart
