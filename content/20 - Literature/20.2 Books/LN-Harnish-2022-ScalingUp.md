...
authors: ["Harnish, Verne"]
first-author: "Harnish"
year: 2022
edition: "Revised"
status: reviewed
topic: business-scaling
relevance: 4
citekey: "@Harnish2022ScalingUp"
venue: "ForbesBooks"
arxiv: ""
doi: ""
...
> **Citation**: Harnish, V. (2022). *Scaling up: How a few companies make it... and why the rest don't* (Revised ed.). ForbesBooks.
> **URL**: https://scalingup.com/bookstore/
...
| C | Assessment |
|---|-----------|
| **Category** | Business scaling framework / strategic execution guide |
| **Context** | Harnish is founder of the Entrepreneurs' Organisation (EO) and the Gazelles growth coaching community. Scaling Up is the evolution of his earlier Rockefeller Habits (2002) — updated with 15 years of additional research and tools |
| **Correctness** | Synthesizes academic strategy research (Collins, Christensen, Porter, Kaplan-Norton) with practitioner experience across 40,000+ companies |
...
| **Clarity** | Very good. Denser than Traction; more academically grounded. Better suited to leaders who have outgrown EOS. |
...
Harnish opens with a stark empirical claim: of the 29 million businesses in the United States, only a few thousand ever reach $10M revenue, and only a few hundred ever reach $100M. The constraint is not market opportunity or capital. It is the **inability to master the Four Decisions** that determine whether a business scales successfully.
...
| Decision | Core Question | Consequence of poor decision |
|----------|--------------|------------------------------|
| **People** | Do you have the right people in the right roles, engaged and motivated? | Turnover, culture erosion, execution gaps |
| **Strategy** | Do you have a clear, differentiated strategy that creates value customers will pay for? | Commoditisation, margin compression, strategic drift |
| **Execution** | Do you have the systems, rhythms, and discipline to execute your strategy? | Inconsistency, wasted effort, missed milestones |
| **Cash** | Do you have the financial intelligence and cash flow to fuel growth? | Profitable companies that run out of cash and die |
...
| Stratum | Question |
|---------|---------|
| 1 | What is your **Core Competence** and Brand Promise? |
| 2 | Who are your **Brand Promises** to customers? |
| 3 | What is the **One-Phrase Strategy** (the Big Idea)? |
| 4 | What do you do **10× better** than anyone else (differentiating activity)? |
| 5 | What is the **X Factor** — the 10–100× underlying advantage? |
| 6 | What is the **Profit/Revenue per X** (economic denominator)? |
| 7 | What is the **BHAG** (Big Hairy Audacious Goal)? |
...
| **Quarterly** | Rocks (critical priorities), Theme, Celebration |
| **Weekly/daily** | KPIs, Critical Numbers, Scoreboard |
...
|---------|-----------|---------|---------|
| Daily huddle | Daily | 15 min | What's up? Where are you stuck? What's the number? |
| Weekly meeting | Weekly | 60–90 min | Scorecard review, priorities, issue resolution |
| Monthly meeting | Monthly | Half day | Education, strategic issues, one-quarter horizon |
| Quarterly planning | Quarterly | 1–2 days | Rock setting, strategy update, team health |
| Annual planning | Annually | 2–3 days | Full strategic review, BHAG progress, culture |
...
|--------------------|-----------|------------|
| **People** | Stage 1–3 | BMAD multi-agent team as scalable "right roles"; HITL as human-agent accountability |
| **Strategy** | Stage 5 | SmartPMO differentiation: automated PM at 10× lower cost per issue triaged |
| **Execution** | Stage 1–3 | PUMA experiment protocol as Meeting Rhythm; Rocks = experiment milestones |
| **Cash** | Stage 5 | License model economics; CCC equivalent = time from issue creation to resolution |
...
- [[50 - Areas/56 Smart-PMO/Smart-PMO-Vision]] — SmartPMO as the scaled outcome of PUMA
- [[20 - Literature/20.2 Books/LN-Wickman-2012-Traction]] — EOS is the stage before Scaling Up; same execution DNA
- [[20 - Literature/20.2 Books/LN-Carpenter-2025-WorkTheSystem]] — SOP documentation as Scaling Up's Process layer
- [[20 - Literature/20.2 Books/LN-Gerber-2009-EMythRevisited]] — The E-Myth motivation; Scaling Up is the blueprint for the mature business
- [[30 - Permanent/31 Concepts/PN-Evaluation-Metrics-Comprehensive]] — PUMA metrics as Scaling Up's Scorecard
- [[30 - Permanent/31 Concepts/PN-UniquenessTrap]] — Scaling Up's BHAG framing as an antidote to the Uniqueness Trap
