---
id: PT-OpenCode-RCOIF-Research
title: "Prompt: OpenCode — RCOIF Academic Research Assistant"
type: prompt-template
tags: [prompt, rcoif, research, academic, academic-writing, ami, anthropic, api, baseline, benchmark, carbon-footprint, chain-of-thought, codecarbon, cot, critical-thinking, dataset, drca, effect-size, effort-estimation, egi, evaluation, falsifiability, few-shot, gpt, hypothesis, ict, iipr, issue-triage, jira, llama, llm, local-llm, meta, metrics, mistral, non-parametric, ollama, openai, popper, precision-recall, project-management, prompt-template, prompting, red-teaming, research-methodology, research-tools, software-engineering, statistics, story-points, sustainability, tawos, template, triage, wilcoxon, zero-shot, zotero]
tool: claude
methodology: rcoif
use_case: research
phase: F0
...
# Prompt: OpenCode — RCOIF Academic Research Assistant
...
- Tone: academic but accessible, suitable for a research project
- Language: English
```
...
**Response quality assessment:** High — OpenCode correctly identified the reproducibility gap as the primary one, citing Angermeir et al. (2025). The "Red Team" section surfaced a valid concern: PUMA's local-only constraint may limit generalisability claims vs. commercial model benchmarks.
...
- OpenCode may generate plausible-sounding citations — always verify in Zotero/primary source
...
- **For paper deconstruction:** 60 - Resources/61 Prompts/61.1 LLM-Tools/PT-OpenCode-DRCA-Paper
- **For iterative improvement:** 60 - Resources/61 Prompts/61.1 LLM-Tools/PT-OpenCode-AMI-Review
- **For exploration:** 60 - Resources/61 Prompts/61.1 LLM-Tools/PT-OpenCode-EGI-Exploration
- **For prompt refinement:** 60 - Resources/61 Prompts/61.1 LLM-Tools/PT-OpenCode-IIPR-Prompt-Refinement
