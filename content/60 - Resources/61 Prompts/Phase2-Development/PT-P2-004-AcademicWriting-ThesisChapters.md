...
**Step**: Academic Writing
**Methodology**: RCOIF + IMRaD structure + the project academic conventions
...
```
Role: Ethical AI researcher writing the social impact section of an academic project.
...
```
Write Section 1.8 (Declaration on the Use of Generative AI) for the PUMA open-source project.
...
3. Ethical principles applied: (a) no delegation of judgment, (b) full traceability (AI Use Log), (c) cross-validation with primary sources, (d) substantial human rewriting, (e) proactive declaration, (f) maintainer validation.
...
These writing prompts generate the first drafts of PUMA's project chapters. Following the AMI principle, every output must be critically reviewed and substantially rewritten before inclusion. The Marco Veritas declaration in Prompt C is a project requirement for all TFGs using AI tools.
