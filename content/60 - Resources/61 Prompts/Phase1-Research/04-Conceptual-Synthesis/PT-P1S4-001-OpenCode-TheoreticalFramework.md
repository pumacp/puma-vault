---
id: PT-P1S4-001
title: "OpenCode — Theoretical Framework Construction for PUMA"
type: prompt-note
tool: claude
...
Context: I am building the theoretical framework for PUMA, a DSR-based project evaluating local LLM agents (Llama 3.2 8B, Mistral 7B) on project management tasks: issue triage (classification on Jira SR) and effort estimation (story points on TAWOS). The study follows Design Science Research and produces a reproducible benchmark with statistical validation (Wilcoxon test).
...
Context: PUMA uses the following concepts that require precise operational definitions for the project: LLM Agent, Multi-Agent System, Issue Triage, Effort Estimation, Story Point, F1-macro, MAE, Few-Shot Prompting, Chain-of-Thought, RAG, Reproducibility, Human-in-the-Loop, Bounded Autonomy, Benchmark.
